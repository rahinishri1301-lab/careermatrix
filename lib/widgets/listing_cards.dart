        ...
        children: [
          Row(
            ...
            children: [
              ...
              if (job.hasApplied)
                const AppTag(label: 'Applied', bg: AppColors.successSoft, fg: AppColors.success, icon: Icons.check_circle_rounded)
              else
          ...
          Row(
            children: [
              ...
              if (showApply)
                if (job.hasApplied)
                  const AppTag(label: 'Applied', bg: AppColors.surfaceMuted, fg: AppColors.textMuted, icon: Icons.check_rounded)
                else
                  SizedBox(
                    height: 34,
