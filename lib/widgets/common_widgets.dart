...
/// Profile avatar that displays network image if available, else falls back to initials.
        ...
        child: ClipOval(
          child: Image.network(
            ...
            errorBuilder: (context, error, stackTrace) {
              return InitialsAvatar(initials: initials, size: size, gradient: gradient);
            },
