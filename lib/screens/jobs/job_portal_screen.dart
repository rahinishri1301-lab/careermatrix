...
class _JobListFuture extends StatelessWidget {
  ...
  void _showJobDetail(BuildContext context, JobListing job) {
    showModalBottomSheet(
      ...
      builder: (_) => _JobDetailSheet(job: job, onApply: onApply),
    );
  }
}
            ...
            children: [
              ...
              Row(
                children: [
                  ...
                  const SizedBox(width: 10),
                  Expanded(child: _InfoChip(icon: Icons.school_outlined, label: job.qualification)),
                ],
              ),
              const SizedBox(height: 12),
              Row(
                children: [
                  Expanded(child: _InfoChip(icon: Icons.badge_outlined, label: job.experience)),
                  const SizedBox(width: 10),
                  Expanded(
                    child: _InfoChip(
                      icon: job.isOpen ? Icons.check_circle_outline_rounded : Icons.cancel_outlined,
              ...
              Text(
                job.description.isNotEmpty
                    ...
                    : 'We are looking for a driven ${job.title} to join our team at ${job.company}. '
                        'You will collaborate with cross-functional teams to deliver impactful outcomes.',
              ...
              if (job.applicationDeadline != null) ...[
                ...
                Row(
                  children: [
                    ...
                    Text(
                      'Deadline: ${job.applicationDeadline!.day}/${job.applicationDeadline!.month}/${job.applicationDeadline!.year}',
