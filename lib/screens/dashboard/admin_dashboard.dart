        ...
        child: ListView(
          ...
          children: [
            ...
            AppCard(
              ...
              child: Column(
                children: [
                  _ManageRow(icon: Icons.people_alt_rounded, label: 'Manage Users & Roles', isUserManagement: true),
...
class _ManageRow extends StatelessWidget {
  ...
  final String label;
  final bool isNav;
  final bool isUserManagement;
  const _ManageRow({required this.icon, required this.label, this.isNav = false, this.isUserManagement = false});
