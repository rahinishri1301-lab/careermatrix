          ...
          actions: [
            IconButton(
              ...
              onPressed: () async {
                ...
                if (saved == true) setState(() => _userFuture = BackendRepository.instance.getMyAppUser());
              },
            ),
            IconButton(
              ...
              Center(
                child: Column(
                  children: [
                    Stack(
                      children: [
                        ProfileAvatar(initials: _initialsFor(displayName), imageUrl: user.profileImageUrl, size: 88),
                        Positioned(
                          bottom: 0,
                          right: 0,
              ...
              AppCard(
                ...
                child: Column(
                  children: [
                    ...
                    const Divider(height: 1, indent: 56),
                    _ProfileRow(icon: Icons.school_outlined, label: 'Education Details', onTap: () async {
                      final saved = await Navigator.of(context).push<bool>(
                        MaterialPageRoute(builder: (_) => const EditProfileScreen()),
                      );
                      if (saved == true) setState(() => _userFuture = BackendRepository.instance.getMyAppUser());
                    ...
                    const Divider(height: 1, indent: 56),
                    _ProfileRow(icon: Icons.workspace_premium_rounded, label: 'Certificates & Achievements', onTap: () => Navigator.of(context).push(MaterialPageRoute(builder: (_) => const CertificatesScreen()))),
                  ],
                ),
              ),
