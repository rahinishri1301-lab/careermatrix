...
router.put('/applications/:id/status', authorize('company', 'alumni', 'admin'), updateInternshipApplicationStatus);
...
router.put('/:id', authorize('company', 'alumni', 'admin'), updateInternshipValidator, validate, updateInternship);

// @route   DELETE /api/internships/:id
router.delete('/:id', authorize('company', 'alumni', 'admin'), internshipIdValidator, validate, deleteInternship);
...
router.get('/:id/applicants', authorize('company', 'alumni', 'admin'), internshipIdValidator, validate, getInternshipApplicants);
