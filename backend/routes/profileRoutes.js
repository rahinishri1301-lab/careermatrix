...
const profileValidationRules = [
  ...
  body('areaOfInterest').optional().isLength({ max: 200 }).withMessage('Area of interest cannot exceed 200 characters'),
  body('careerGoal').optional().isLength({ max: 300 }).withMessage('Career goal cannot exceed 300 characters'),
